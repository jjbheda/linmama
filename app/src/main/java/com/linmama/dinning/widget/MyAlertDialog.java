...
public class MyAlertDialog {
	...
	public MyAlertDialog setEditInputType(int type) {
		showEditText = true;
		edittxt_result.setInputType(type);
		return this;
	}

	public MyAlertDialog setEditHint(String msg) {
		showEditText = true;
		if ("".equals(msg)) {
			edittxt_result.setHint("内容");
		} else {
	...
	public MyAlertDialog setMsg(int resId) {
		return setMsg(context.getString(resId));
	}
	...
	public MyAlertDialog setPositiveButton(int resId, final OnClickListener listener) {
	...
	public MyAlertDialog setConfirmButton(String text, final ICallBack callBack) {
		showPosBtn = true;
		if ("".equals(text)) {
			btn_pos.setText("确定");
		} else {
	...
	public MyAlertDialog setNegativeButton(int resId, final OnClickListener listener) {
