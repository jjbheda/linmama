...
public class QuitOrderInfoBean implements Parcelable {
    private int id;
    ...
    public QuitOrderInfoBean() {
    }

    protected QuitOrderInfoBean(Parcel in) {
        this.id = in.readInt();
    ...
    public static final Parcelable.Creator<QuitOrderInfoBean> CREATOR = new Parcelable.Creator<QuitOrderInfoBean>() {
        @Override
        public QuitOrderInfoBean createFromParcel(Parcel source) {
            return new QuitOrderInfoBean(source);
        }

        @Override
        public QuitOrderInfoBean[] newArray(int size) {
            return new QuitOrderInfoBean[size];
        }
    };
}
