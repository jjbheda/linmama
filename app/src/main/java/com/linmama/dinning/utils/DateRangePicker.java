...
import com.linmama.dinning.widget.date.DateLogUtils;
import com.linmama.dinning.widget.date.DateUtils;
import com.linmama.dinning.widget.date.WheelPicker;
import com.linmama.dinning.widget.date.WheelView;
...
public class DateRangePicker extends WheelPicker {
    ...
    public void setSelectedItem(int year, int month, int day) {
        ...
        DateLogUtils.verbose(this, "change months and days while set selected");
    ...
    public void setSelectedItem(int yearOrMonth, int monthOrDay) {
        ...
        if (dateMode == MONTH_DAY) {
            ...
            DateLogUtils.verbose(this, "change months while set selected");
    ...
    protected View makeCenterView() {
        ...
        if ((dateMode == YEAR_MONTH_DAY || dateMode == YEAR_MONTH) && years.size() == 0) {
            DateLogUtils.verbose(this, "init years before make view");
            initYearData();
        }
        if (dateMode != NONE && months.size() == 0) {
            DateLogUtils.verbose(this, "init months before make view");
        ...
        if ((dateMode == YEAR_MONTH_DAY || dateMode == MONTH_DAY) && days.size() == 0) {
            DateLogUtils.verbose(this, "init days before make view");
            int selectedYear;
            if (dateMode == YEAR_MONTH_DAY) {
        ...
        if (dateMode == YEAR_MONTH_DAY || dateMode == YEAR_MONTH) {
            ...
            startYearView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
                ...
                public void onSelected(int index) {
                    ...
                    DateLogUtils.verbose(this, "change months after year wheeled");
                    if (resetWhileWheel) {
        ...
        if (dateMode != NONE) {
            ...
            startMonthView.setOnItemSelectListener(new WheelView.OnItemSelectListener() {
                ...
                public void onSelected(int index) {
                    ...
                    if (dateMode == YEAR_MONTH_DAY || dateMode == MONTH_DAY) {
                        DateLogUtils.verbose(this, "change days after month wheeled");
                        if (resetWhileWheel) {
                            selectedDayIndex = 0;//重置日子索引
                        }
                        int selectedYear;
    ...
    private void changeMonthData(int selectedYear) {
        ...
        if (!resetWhileWheel) {
            ...
            DateLogUtils.verbose(this, "preSelectMonth=" + preSelectMonth);
        }
        months.clear();
    ...
    private void changeDayData(int selectedYear, int selectedMonth) {
        ...
        if (!resetWhileWheel) {
            ...
            DateLogUtils.verbose(this, "maxDays=" + maxDays + ", preSelectDay=" + preSelectDay);
        }
        days.clear();
